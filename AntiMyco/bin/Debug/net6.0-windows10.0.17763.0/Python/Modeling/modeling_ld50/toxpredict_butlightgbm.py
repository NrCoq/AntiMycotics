...
model = LGBMRegressor(n_estimators=100000, boosting_type='goss')

model.fit(train_x, train_y, eval_set=(test_x, test_y), eval_metric=['rmse'], early_stopping_rounds=5000)
